class CapturedViolatorsController < ApplicationController
  ...
  def encode_license_plate
    ...
    @violator = CapturedViolator.create!(capture_date: @capture_date, violation: "Number Coding", location: "Cam 1", penalty_amount: "500.00", license_plate_text: params[:license_plate_text], raw_image_orig_path: @car_image_file_name, license_plate_image_orig_path: @license_plate_image_file_name)
